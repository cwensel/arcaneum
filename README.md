...
arc corpus repair NAME                          # Repair content/integrity issues, not policy-only files
arc corpus repair NAME --include-stale-policy   # Also migrate stale/legacy indexing policies
