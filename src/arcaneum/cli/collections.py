...
def list_collections_command(verbose: bool, output_json: bool):
    ...
    Args:
        ...
        output_json: Output as JSON
    """
    with interaction_logger.track("collection", "list") as ctx:
        try:
            client = create_qdrant_client()
            ...
            ctx["result_count"] = len(collections.collections)
...
def delete_collection_command(name: str, confirm: bool, output_json: bool):
    ...
    Args:
        ...
        output_json: Output as JSON
    """
    with interaction_logger.track("collection", "delete", collection=name) as ctx:
        try:
            if not confirm:
                if output_json:
...
def info_collection_command(name: str, output_json: bool):
    ...
    Args:
        ...
        output_json: Output as JSON
    """
    with interaction_logger.track("collection", "info", collection=name) as ctx:
        try:
            client = create_qdrant_client()
...
def items_collection_command(name: str, output_json: bool):
    ...
    Args:
        ...
        output_json: Output as JSON
    """
    with interaction_logger.track("collection", "items", collection=name) as ctx:
        try:
            client = create_qdrant_client()
...
def verify_collection_command(
    ...
    with interaction_logger.track(
        ...
        try:
            ...
            if output_json:
                ...
                if result.collection_type == "code":
                    ...
                    for file in result.files:
                        ...
                        quality_manifest = getattr(file, "quality_manifest", None)
            ...
            ctx["result_count"] = result.total_items
...
def export_collection_command(
    ...
    with interaction_logger.track(
        ...
        try:
            ...
            ctx["exported_count"] = result.exported_count
            ctx["file_size_bytes"] = result.file_size_bytes
...
def import_collection_command(
    ...
    with interaction_logger.track(
        ...
        try:
            ...
            ctx["imported_count"] = result.imported_count
            ctx["collection_name"] = result.collection_name
